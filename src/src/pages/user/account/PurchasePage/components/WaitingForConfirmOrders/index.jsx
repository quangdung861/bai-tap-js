...
import { Row, Col, Button, Spin, Skeleton } from "antd";
...
const WaitingForConfirmOrders = () => {
  ...
  return (
    <S.Wrapper>
      <Skeleton style={{ marginTop: 40 }} active loading={orderList.loading}>
        {renderOderList}
      </Skeleton>
    </S.Wrapper>
  );
...
export default WaitingForConfirmOrders;
